...
export default React.memo(function EmergencyPanel({ onAction, cooldown }) {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sp-2)' }}>
      ...
      <DwellButton
        ...
        disabled={cooldown?.emergency ?? false}
      ...
      <DwellButton
        ...
        disabled={cooldown?.caregiver ?? false}
      ...
      <DwellButton
        ...
        disabled={cooldown?.quickmsg ?? false}
